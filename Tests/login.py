# для фикстур
# python -m pytest -v --html=.\Reports\report.html --driver Chrome --driver-path C:\Users\Комп\PycharmProjects\pythonProject1\chromedriver.exe Tests\login.py
...
class LoginTest(unittest.TestCase):
    ...
    def test_01_invalid_username_message(self):
        ...
        login.enter_username('aleksey@mail.ru')
        login.enter_password('1234567890')
        login.click_login()
